...
<div class="page-title">
    <div class="container">
        <div class="page-caption">
            <h2>Buying Job</h2>
            <p><a href="{{ url('/') }}" title="Home">Home</a> <i class="ti-arrow-right"></i> Buying Job</p>
        </div>
    </div>
</div>
<!-- ======================= End Page Title ===================== -->
                    ...
                    <div class="vertical-job-card">
                        <div class="vertical-job-header">
                            <div class="vrt-job-cmp-logo">
                                <a href="javascript:void(0);"> 
                                    <img src="{{ url('/uploads/services/'.$one->image) }}" class="img-responsive" alt="" />
                                </a>
                            </div>
                            <h4><a href="javascript:void(0);">{{ $one->{$slug->title} }}</a></h4>
                            <span class="com-tagline">{{ $one->category->{$slug->title} }}</span>
                        ...
                        <div class="vertical-job-body">
                            <div class="row">
                                <div class="col-md-9 col-sm-8">
                                    <ul class="can-skils">
                                        <li><strong>Job Id: </strong>J-{{ $one->id }}</li> 
                                        <li><strong>Skills: </strong>                                                                                    
                                            @php($skills = explode(",", $one->skills))
                                            @foreach($skills as $value)
                                            <span class="skill-tag">{{ $value }}</span>
                                            @endforeach
                                        </li>
                                        <li><strong>Experience: </strong>{{ $one->seller->experience }}</li>
                                        <li><strong>Location: </strong>{{ $one->seller->location }}</li>
                                    </ul>
                                </div>
                                <div class="col-md-3 col-sm-4">
                                    <div class="vrt-job-act">
                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#apply-job" class="btn-job theme-btn job-apply">Apply Now</a>
