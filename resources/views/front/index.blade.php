...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="item {{ $active }}">
            <img src="{{ url('uploads/images/'.$one->image) }}">
            <div class="carousel-caption">
                <h4><a href="javascript:;">{{ $one->title_en }}</p>
            </div>
        </div><!-- End Item -->
        @endforeach
    ...
    <ul class="list-group col-sm-4">
        ...
        @foreach($sliders as $key2 => $one2)
        @if($key2 == 0)
        @php($active2 = "active")
        @else 
        @php($active2 = "")
        @endif
        <li data-target="#myCarousel" data-slide-to="{{ ($key2+1) }}" class="list-group-item {{$active2}}"><h4>
            {{$one2->title_en}}            
        </h4></li>
        @endforeach
    </ul>
            ...
            <div class="col-lg-12">
                ...
                <div class="content-block">
                    ...
                    <div class="cb-content avatars">
                        <!-- <div class="row">
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava2.png" alt="">
                                 <div class="note">1</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava3.png" alt="">
                                 <div class="note">03</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava4.png" alt="">
                                 <div class="note">10</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava5.png" alt="">
                                 <div class="note">56</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava6.png" alt="">
                                 <div class="note">6</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava7.png" alt="">
                                 <div class="note">25</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava8.png" alt="">
                                 <div class="note">23</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava9.png" alt="">
                                 <div class="note">16</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava10.png" alt="">
                                 <div class="note">3</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava11.png" alt="">
                                 <div class="note">6</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava12.png" alt="">
                                 <div class="note">98</div>
                             </a></div>
                             <div class="col-lg-1 col-sm-2 col-xs-4"><a href="#"><img src="images/ava1.png" alt="">
                ...
                <div class="content-block head-div">
                    <div class="cb-header">Popular Channels
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-xs-8">
                                <ul class="list-inline">
                                    <li><a href="#" class="color-active">Featured Videos</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">Man's Sky: 21 Minutes of New Gameplay - IGN
                                            First</a>
                                    </div>
                                    <div class="v-views">
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">GTA 5: Michael, Franklin, and Trevor in the
                                            Flesh</a>
                                    </div>
                                    <div class="v-views">
                                        8,241,542 views. <span class="v-percent"><span
                                            class="v-circle"></span> 93%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">Battlefield 3: Official Fault Line Gameplay
                                            Trailer</a>
                                    </div>
                                    <div class="v-views">
                                        2,729,347 views . <span class="v-percent"><span
                                            class="v-circle"></span> 95%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video">
                                    ...
                                    <div class="v-views">
                                        7,239,852 views. <span class="v-percent"><span
                                            class="v-circle"></span> 84%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video last-row">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">Amazon Blocking VIDEO GAMES for
                                            Non-Prime...</a>
                                    </div>
                                    <div class="v-views">
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video last-row">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">Amazing Facts About Nebulas Inside Deep
                                            Universe</a>
                                    </div>
                                    <div class="v-views">
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video last-row">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">Cornfield Chase - Outlast II Official
                                            Gameplay</a>
                                    </div>
                                    <div class="v-views">
                ...
                <div class="content-block head-div">
                    <div class="cb-header">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-xs-8">
                                <ul class="list-inline">
                                    <li><a href="#" class="color-active">New Videos in India</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">There Can Only Be One! Introducing Tanc &
                                            Hercules</a>
                                    </div>
                                    <div class="v-views">
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">Pokémon 3: The Movie - Spell Of The Unown:
                                            Entei HD...</a>
                                    </div>
                                    <div class="v-views">
                                        18,241,542 views. <span class="v-percent"><span
                                            class="v-circle"></span> 93%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">Bullet Trains and Octopus Balls in South
                                            Korea</a>
                                    </div>
                                    <div class="v-views">
                                        729,347 views . <span class="v-percent"><span
                                            class="v-circle"></span> 95%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video">
                                    ...
                                    <div class="v-views">
                                        79,239,852 views. <span class="v-percent"><span
                                            class="v-circle"></span> 84%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video last-row">
                                    ...
                                    <div class="v-desc">
                                        <a href="single-video-tabs.html">Mirror's Edge Catalyst Beta: PS4 vs Xbox One
                                            Frame-Rate... </a>
                                    </div>
                                    <div class="v-views">
                            ...
                            <div class="col-lg-3 col-sm-6 videoitem">
                                <div class="b-video last-row">
                                    ...
                                    <div class="v-views">
                                        3,202,513 views. <span class="v-percent"><span
                                            class="v-circle"></span> 84%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="b-playlist">
                                    <div class="v-img">
                                        ...
                                        <a href="single-video-tabs.html"><img src="images/playlist-1.png" alt=""
                                                                              class="l-3"/></a>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="b-playlist">
                                    <div class="v-img">
                                        ...
                                        <a href="single-video-tabs.html"><img src="images/playlist-2.png" alt=""
                                                                              class="l-3"></a>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="b-playlist">
                                    <div class="v-img">
                                        ...
                                        <a href="single-video-tabs.html"><img src="images/playlist-3.png" alt=""
                                                                              class="l-3"></a>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="b-playlist">
                                    <div class="v-img">
                                        ...
                                        <a href="single-video-tabs.html"><img src="images/playlist-4.png" alt=""
                                                                              class="l-3"></a>
                        ...
                        <div class="item active">
                            <div class="col-md-4 col-sm-6">
                                <div class="block-text rel zmin">
                                    ...
                                    <p>Never before has there been a good film portrayal of ancient Greece's favourite
                                        myth. So why would Hollywood start now? This latest attempt at bringing the son
                                        of Zeus to the big screen is brought to us by X-Men: The last Stand director
                                        Brett Ratner. If the name of the director wasn't enough to dissuade ...</p>
                            ...
                            <div class="col-md-4 col-sm-6 hidden-xs">
                                <div class="block-text rel zmin">
                                    ...
                                    <div class="mark">My rating: <span class="rating-input"><span data-value="0"
                                            ...
                                            data-value="5" class="glyphicon glyphicon-star-empty"></span>  </span></div>
                                    <p>The 2013 movie "The Purge" left a bad taste in all of our mouths as nothing more
                                        than a pseudo-slasher with a hamfisted plot, poor pacing, and a desperate
                                        attempt at "horror." Upon seeing the first trailer for "The Purge: Anarchy," my
                                        first and most immediate thought was "we really don't need another one of
                                        these." </p>
                                    <ins class="ab zmin sprite sprite-i-triangle block"></ins>
                                </div>
                                <div class="person-text rel">
                            ...
                            <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                                <div class="block-text rel zmin">
                                    ...
                                    <p>What a funny and entertaining film! I did not know what to expect, this is the
                                        fourth film in this vehicle's universe with the two Cars movies and then the
                                        first Planes movie. I was wondering if maybe Disney pushed it a little bit.
                                        However, Planes: Fire and Rescue is an entertaining film that is a fantastic
                                        sequel in this magical franchise. </p>
                                    <ins class="ab zmin sprite sprite-i-triangle block"></ins>
                                </div>
                                <div class="person-text rel">
