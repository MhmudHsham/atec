            ...
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase">
                        <a class="btn btn-info" href="{{ url('/admin/materials/create/'.$course_id) }}">إضافة جديد</a>
                    </span>
                </div>
                <div class="tools"> </div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                    <thead>
                        <tr>
                            <th class="all"># </th>
                            <th class="all"> إسم المحتوى</th>
                            <th class="all"> صورة المحتوى </th>
                            <th class="all">إسم الكورس</th>
                            ...
                            <td>
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right"> 
                                        <li>
                                            <a href="{{ url("/admin/materials/")."/".$one->id . "/edit" }}">
                                                <i class="fa fa-pencil-square-o"></i> تعديل </a>
                                        </li>
                                        <li>
                                            <a data-id="{{ $one->id }}" class="delete-url" href="{{ url("/admin/courses/")."/".$one->id }}">
