                                            ...
                                            <div class="portlet light ">
                                                <div class="portlet-title tabbable-line">
                                                    ...
                                                    <ul class="nav nav-tabs">
                                                        <li class="active">
                                                            <a href="#tab_1_1" data-toggle="tab">بيانات الحساب</a>
                                                        </li>
                                                        <li>
                                                            <a href="#tab_1_2" data-toggle="tab">الصورة الشخصية</a>
                                                        </li>
                                                        <li>
                                                            <a href="#tab_1_3" data-toggle="tab">تغيير كلمة السر</a>
                                                        </li> 
                                                    </ul>
                                                </div>
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane active" id="tab_1_1">
                                                            <form role="form" action="{{ url('/admin/update_data') }}" method="post">
                                                                {{ csrf_field() }}
                                                                <div class="form-group">
                                                                    <label class="control-label">الإسم</label>
                                                                    <input type="text" name="name" value="{{ Auth::user()->name }}" placeholder="" class="form-control" /> 
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">البريد الإلكتروني</label>
                                                                    <input type="text" name="email" value="{{ Auth::user()->email }}" placeholder="" class="form-control" /> 
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">الوظيفة</label>
                                                                    <input type="text" name="position" value="{{ $details->position }}" placeholder="" class="form-control" /> 
                                                                </div>                                                                
                                                                <div class="form-group">
                                                                    <label class="control-label">السيرة</label>
                                                                    <textarea class="form-control" rows="3" placeholder="" name="bio">{{ $details->bio }}</textarea>
                                                                </div>                                                                
                                                        ...
                                                        <div class="tab-pane" id="tab_1_2"> 
                                                            <form action="{{ url('/admin/update_image') }}" role="form" method="post" enctype="multipart/form-data">
                                                                {{ csrf_field() }}
                                                                <div class="form-group">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                            <img src="{{ url('/public/uploads/images') . '/' . $details->image }}" alt="" /> </div>
                                                        ...
                                                        <div class="tab-pane" id="tab_1_3">
                                                            <form action="{{ url('/admin/change_password') }}" method="post">
                                                                {{ csrf_field() }}  
                                                                <div class="form-group">
                                                                    <label class="control-label">كلمة السر الحالية</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label">تأكيد كلمة السر الجديدة</label>
