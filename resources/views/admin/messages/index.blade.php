...
<script src="{!! url('assets/admin/mine/message.js') !!}"></script>
@stop
                            ...
                            <td>
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="{{ url("/admin/messages/")."/".$one->id . "/edit" }}">
                                                <i class="fa fa-pencil-square-o"></i> تعديل </a>
                                        </li>
                                        <li>
                                            <a data-id="{{ $one->id }}" class="delete-url" href="{{ url("/admin/messages/")."/".$one->id }}">
