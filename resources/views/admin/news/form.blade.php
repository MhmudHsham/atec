    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                @if($id == 0)
                @php($action = url('/admin/news'))
                @else
                @php($action = url('/admin/news/apply_update'). "/" . $id)
                <input type="hidden" value="news/{{ $id }}" id="show_link">
                @endif
                <!-- BEGIN FORM   -->
                <form action="{{ $action }}" enctype="multipart/form-data" class="form-horizontal" id="current_form" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input">
                            <label class="col-md-2 control-label" for="form_control_1">صورة الخبر
                        ...
                        <div class="form-group form-md-line-input">
                            <label class="col-md-2 control-label" for="form_control_1">عنوان الخبر بالعربية
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group form-md-line-input">
                            <label class="col-md-2 control-label" for="form_control_1">عنوان الخبر بالإنجليزية
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" placeholder="" name="title_en" id="title_en">
                                <div class="form-control-focus"> </div>
                                <span class="help-block">ادخل عنوان الخبر بالإنجليزية</span>
                            </div>
                        </div>
